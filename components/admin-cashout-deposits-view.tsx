...
export function AdminCashoutDepositsView({ items }: { items: UserCashoutDeposit[] }) {
  ...
  return <div className="admin-page-stack">
    <div className="admin-page-intro"><div><span>Deposit verification</span><h1>{t('cashoutDepositRequests')}</h1><p>{t('oneTimeDepositAdminHelp')}</p></div><div className="admin-intro-count"><strong>{items.length}</strong><span>Requests</span></div></div>
