...
export function AdminCashoutsView({ items, depositItems }: { items: Cashout[]; depositItems: UserCashoutDeposit[] }) {
  ...
  return <div className="admin-page-stack">
    <div className="admin-page-intro">
      <div><span>Cash out management</span><h1>{t('manageCashouts')}</h1><p>{t('manageCashoutsHelp')}</p></div>
      <div className="admin-intro-count"><strong>{items.length + depositItems.length}</strong><span>Items</span></div>
    </div>
