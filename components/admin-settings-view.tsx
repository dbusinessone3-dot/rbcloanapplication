...
export function AdminSettingsView({
  ...
  return <div className="admin-page-stack admin-settings-stack">
    <div className="admin-page-intro"><div><span>Configuration</span><h1>{t('settings')}</h1><p>Manage loan rates and payment receiver information.</p></div></div>
