      ...
      <section className="content-grid loan-detail-layout">
        <div className="card mobile-look-card">
          <div className="card-header mobile-card-header">
            ...
            <Link href={`/loan/cashout?loan=${loan.id}`} className="primary-btn">
              {t('cashout')}
            </Link>
          </div>
          <div className="card-body summary-list">
            ...
            <div className="detail-action-row">
              <Link href={`/loan/cashout?loan=${loan.id}`} className="primary-btn">{t('cashout')}</Link>
              <Link href="/installments" className="secondary-btn">{t('installments')}</Link>
            </div>
          </div>
        </div>
